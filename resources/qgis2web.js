...
map.getView().fit([-19904865.967845, -44927335.427097, 19046187.515069, 44927335.427097], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Aquifers of the World</h2>';
        return titleElement;
    })(),
